# 0.16.0
  ...
  - [Full changelog](https://github.com/OpenSpace/OpenSpace/releases/tag/releases%2Fv0.16.0)
...
### New exoplanets menu
See [Exoplanets](/using-openspace/toolbar/exoplanet-systems/index) for a detailed overview and instructions.

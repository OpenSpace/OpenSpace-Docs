...
**Platform:** macOS support has been removed due to Apple's long-standing failure to advance their OpenGL support. OpenSpace now targets **OpenGL 4.6**, delivering improved rendering performance across the board in the entire application.
...
### Updates to existing Assets/Profiles
  ...
  - Retire WSA 5.4 assets in favor of version 6.2 for Today's Sun profile (#3932, #3992, #4028)

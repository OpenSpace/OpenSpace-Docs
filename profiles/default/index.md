...
{octicon}`rocket;1.5em;sd-text-danger` Start a slow orbit around Earth.
:::
...
:::{figure} moon_orbit.png
:width: 75%
:align: center
:alt: Moon's orbit

{octicon}`rocket;1.5em;sd-text-danger` Pull away from Earth so that the Moon's orbit is in full view, and continue orbiting Earth.
:::

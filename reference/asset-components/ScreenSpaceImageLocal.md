...
This `ScreenSpaceRenderable` can be used to display an image from a local file on disk.

To load an image from a web URL, see [ScreenSpaceImageOnline](#base_screenspace_image_online).
